...
public class BlockingRestTemplateCustomizer implements RestTemplateCustomizer {
    ...
    public BlockingRestTemplateCustomizer(@Value("${inspo.httpclient.maxtotalconnections}") Integer maxTotalConnections,
                                          @Value("${inspo.httpclient.defaultmaxtotalconnections}") Integer defaultMaxTotalConnetions,
